        ...
        <div>
            <div className='flex justify-center font-cormorantMedium text-slate-900 bg-bgImage bg-contain'>
                <div className='p-16'>
                    ...
                    <div className='py-4 flex justify-center'>Read and write some Haiku today</div>
                    {loggedIn===true&&(
                        <>
                            <Link to='/create'>
                                <div className='flex justify-center border-sky-900 hover:bg-sky-900 hover:text-slate-200 border-2 text-sky-900 font-spectral active:bg-slate-700 font-bold text-sm cursor-pointer text-center py-2 px-4 rounded-full uppercase'>Start writing</div>
                            </Link>
                        </>
                    )} 
                    {loggedIn===false&&(
